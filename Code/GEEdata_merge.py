...
file_directory = 'data/PDSI_2001-2024'   
outputpath = 'Brazil data and code/Data'
output_file_path = os.path.join(outputpath, 'Palmer_Drought_Severity_Index.csv')
################################################################
...
for file in files:
    ...
    # Rename columns
    data = data.rename(columns={'mean': file_id})
    # View column names
    print(data.columns)  
